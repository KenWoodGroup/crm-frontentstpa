...
import ManagerCompanyCreate from "./_components/ManagerCompanyCreate";
import ManagerCompanyDelete from "./_components/ManagerCompanyDelete";
import ManagerCompanyEdit from "./_components/ManagerCompanyEdit";
...
export default function ManagerCompany() {
    ...
    const GetAllFactory = useCallback(async (pageNum = 1, append = false) => {
        ...
        try {
            const data = { type: "company", page: pageNum };
    ...
    return (
        <div className="min-h-screen text-gray-900 dark:text-gray-100">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <ManagerCompanyCreate refresh={refresh} />
            </div>
            {factories?.length > 0 ? (
                <>
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-[10px]">
                                        <ManagerCompanyDelete id={factory.id} refresh={refresh} />
                                        <ManagerCompanyEdit data={factory} refresh={refresh} />
                                    </div>
                                </div>
                ...
                <EmptyData text="Kompanyalar topilmadi" />
            )}
        </div>
    );
}
