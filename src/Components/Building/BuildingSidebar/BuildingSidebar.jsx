...
export default function BuildingSidebar() {
    const mainLinks = [
        { id: 1, label: "Home", path: "/building/dashboard", icon: LayoutDashboard },
    ];
    const kassaSubLinks = [
        { id: 4, label: "Доставщик", path: "/building/carrier", icon: Truck, group: "suppliers" },
        { id: 4, label: "Поставщик", path: "/building/suppliers", icon: UsersRound, group: "suppliers" },
    ];
    const skladSubLinks = [
        { id: 1, label: "Склад", path: "/building/stock", icon: Package },
        ...
        ">
            ...
            <div className="flex flex-col items-center gap-4">
                ...
                <Menu placement="right-start" allowHover offset={15}>
                    ...
                    <MenuList className={`p-4  w-[230px] grid-cols-1 translate-x-6 bg-white/95 dark:bg-gray-900 backdrop-blur-md shadow-2xl border border-gray-100 dark:border-gray-700 rounded-xl grid gap-4 transition-colors duration-300`}>
