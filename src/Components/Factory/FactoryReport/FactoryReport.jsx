...
export default function FactoryReport() {
    ...
    return (
        <div className="min-h-screen">
            {/* Sarlavha */}
            <div className="mb-8">
                <Typography variant="h2" className="text-black font-bold mb-2">
                ...
                <div className="lg:col-span-1">
                    ...
                    <div className="space-y-4">
                        {storages.map((storage) => (
                            <Card
                                key={storage.id}
                                className={`bg-white shadow-md border-2 cursor-pointer transition-all ${selectedStorage?.id === storage.id ? 'border-black bg-gray-50' : 'border-gray-300'
                                    }`}
                    ...
                    {selectedStorage ? (
                        <div className="space-y-4">
                            {getDealersForStorage(selectedStorage.id).map((dealer) => (
                                <Card key={dealer.id} className="bg-white shadow-md border border-gray-300">
                                    <CardBody>
                        ...
                        <Card className="bg-white shadow-md border border-gray-300">
