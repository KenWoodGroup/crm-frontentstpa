...
import CompanyWarehouseExpensesCreate from "./_components/CompanyWarehouseExpensesCreate";
import Cookies from "js-cookie";
import Loading from "../../UI/Loadings/Loading";
import EmptyData from "../../UI/NoData/EmptyData";
import CompanyWarehouseExpensesDelete from "./_components/CompanyWarehouseExpensesDelete";
import CompanyWarehouseExpensesEdit from "./_components/CompanyWarehouseExpensesEdit";
...
export default function CompanyWarehouseExpenses() {
        ...
        <div className="min-h-screen bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark">
            ...
            <div className="flex flex-wrap items-center justify-between mb-6 gap-4">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    {/* Добавление */}
                    <CompanyWarehouseExpensesCreate refresh={GetAllExpenses} />
                </div>
            </div>
                                    ...
                                    {data.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-1 py-3 text-sm">
                                                <div className="flex items-center gap-2">
                                                    <CompanyWarehouseExpensesEdit
                                                        data={item}
                                                        refresh={GetAllExpenses}
                                                    />
                                                    <CompanyWarehouseExpensesDelete
                                                        id={item?.id}
                                                        refresh={GetAllExpenses}
                                                    />
                                                </div>
