...
import CompanyWarehouseСarrierCreate from "./_components/CompanyWarehouseСarrierCreate";
import { Staff } from "../../../utils/Controllers/Staff";
import Cookies from "js-cookie";
import CompanyWarehouseСarrierDelete from "./_components/CompanyWarehouseСarrierDelete";
import CompanyWarehouseСarrierEdit from "./_components/CompanyWarehouseСarrierEdit";

export default function CompanyWarehouseCarrier() {
    ...
    return (
        <div className="min-h-screen transition-colors duration-300 bg-background-light dark:bg-background-dark">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
                ...
                <CompanyWarehouseСarrierCreate refresh={GetStaff} />
            </div>
                                ...
                                {clients.map((client, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="p-3 text-center flex justify-center gap-2">
                                            <CompanyWarehouseСarrierEdit
                                                id={client?.id}
                                                data={client}
                                                refresh={GetStaff}
                                            />
                                            <CompanyWarehouseСarrierDelete
                                                id={client?.id}
                                                refresh={GetStaff}
                                            />
                                        </td>
