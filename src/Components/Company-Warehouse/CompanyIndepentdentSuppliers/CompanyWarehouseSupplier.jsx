...
import CompanyWarehouseSupplierCreate from "./_components/CompanyWarehouseSupplierCreate";
import CompanyWarehouseSupplierDelete from "./_components/CompanyWarehouseSupplierDelete";
import CompanyWarehouseSupplierEdit from "./_components/CompanyWarehouseSupplierEdit";
import CompanyWarehouseSupplierPayment from "./_components/CompanyWarehouseSupplierPayment";

export default function CompanyWarehouseSupplier() {
    ...
    return (
        ...
        >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
                ...
                <CompanyWarehouseSupplierCreate refresh={() => GetAllSupplier(search, page)} />
            </div>
                                    ...
                                    {suppliers.map((supplier, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-3 text-center flex justify-center gap-2">
                                                <CompanyWarehouseSupplierEdit id={supplier?.id} data={supplier} refresh={() => GetAllSupplier(search, page)} />
                                                <CompanyWarehouseSupplierDelete id={supplier?.id} refresh={() => GetAllSupplier(search, page)} />
                                                <CompanyWarehouseSupplierPayment refresh={() => GetAllSupplier(search, page)} supplier={supplier} />
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
