...
export default function CompanyWarehouseSidebar() {
    const mainLinks = [
        { id: 1, label: "Home", path: "/company-warehouse/dashboard", icon: LayoutDashboard },
    ];
    const kassaSubLinks = [
        { id: 7, label: "Обекты", path: "/company-warehouse/objects", icon: HardHat, group: "suppliers" },
        { id: 4, label: "Доставщик", path: "/company-warehouse/carrier", icon: Truck, group: "suppliers" },
        { id: 6, label: "Расходы", path: "/company-warehouse/expenses", icon: Blocks, group: "others" },
        { id: 7, label: "Касса", path: "/company-warehouse/kassa", icon: CreditCard, group: "others" },
        { id: 4, label: "Поставщик", path: "/company-warehouse/suppliers", icon: UsersRound, group: "suppliers" },
        { id: 4, label: "Сверка Поставщиков", path: "/company-warehouse/suppliers/sverka", icon: ChevronsLeftRight, group: "suppliers" },
        { id: 4, label: "Оплата Поставщиков", path: "/company-warehouse/suppliers/payment", icon: BanknoteArrowDown, group: "suppliers" },
    ];
    const skladSubLinks = [
        { id: 1, label: "Склад", path: "/company-warehouse/stock", icon: Package },
        ...
        ">
            ...
            <div className="flex flex-col items-center gap-4">
                ...
                <Menu placement="right-start" allowHover offset={15}>
                    ...
                    <MenuList className={`p-4  w-[430px] grid-cols-2 translate-x-6 bg-white/95 dark:bg-gray-900 backdrop-blur-md shadow-2xl border border-gray-100 dark:border-gray-700 rounded-xl grid gap-4 transition-colors duration-300`}>
