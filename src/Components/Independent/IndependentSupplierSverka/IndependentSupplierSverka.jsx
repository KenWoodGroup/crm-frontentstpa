...
export default function IndependentSupplierSverka() {
    ...
    const getAllClient = async () => {
        ...
        try {
            const response = await location.GetAllSuppliers(Cookies?.get("ul_nesw"));
            if (response?.data) {
    ...
    const getSverka = async (page = 1) => {
        ...
        try {
            ...
            const response = await Payment.supplierSverkaGet(data);
                                    ...
                                    <tbody>
                                        {
                                            history.map((item, index) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="p-3 border-b border-gray-200 dark:border-gray-700 text-text-light dark:text-text-dark transition-colors duration-200">{item.payer?.name || '-'}</td>
                                                    <td className="p-3 border-b border-gray-200 dark:border-gray-700 text-text-light dark:text-text-dark transition-colors duration-200">{item.receiver?.name || '-'}</td>
                                                    <td className="p-3 border-b border-gray-200 dark:border-gray-700 text-text-light dark:text-text-dark transition-colors duration-200 text-green-600 font-semibold">
