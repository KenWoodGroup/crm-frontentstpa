...
import IndependentClientCreate from "./_components/IndependentClientCreate";
import IndependentClientDelete from "./_components/IndependentClientDelete";
import IndependentClientsEdit from "./_components/IndependentClientsEdit";
import IndependentClientPayment from "./_components/IndependentClientPayment";

export default function IndependentClients() {
        ...
        >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
                ...
                <div className="flex items-center gap-3">
                    <IndependentClientCreate refresh={() => GetAllClient(search, page)} />
                </div>
            </div>
                                        ...
                                        >
                                            <td className="p-3 font-medium">
                                                <NavLink
                                                    ...
                                                    to={`/independent/client-detail/${client?.id}`}
                                                >
                                                    {client.name}
                                                </NavLink>
                                            </td>
                                            ...
                                            <td className="p-3 text-center flex justify-center gap-2">
                                                <IndependentClientsEdit
                                                    id={client?.id}
                                                    data={client}
                                                    refresh={() => GetAllClient(search, page)}
                                                />
                                                <IndependentClientDelete
                                                    id={client?.id}
                                                    refresh={() => GetAllClient(search, page)}
                                                />
                                                <IndependentClientPayment
                                                    refresh={() => GetAllClient(search, page)}
                                                    client={client}
                                                />
                                            </td>
