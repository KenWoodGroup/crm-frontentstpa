...
import IndependentExpensesEdit from "./_components/IndependentExpensesEdit";
import IndependentExpensesDelete from "./_components/IndependentExpensesDelete";
import IndependentExpensesCreate from "./_components/IndependentExpensesCreate";
...
export default function IndependentExpenses() {
        ...
        <div className="min-h-screen bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark">
            ...
            <div className="flex flex-wrap items-center justify-between mb-6 gap-4">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    {/* Добавление */}
                    <IndependentExpensesCreate refresh={GetAllExpenses} />
                </div>
            </div>
                                    ...
                                    {data.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-1 py-3 text-sm">
                                                <div className="flex items-center gap-2">
                                                    <IndependentExpensesEdit
                                                        data={item}
                                                        refresh={GetAllExpenses}
                                                    />
                                                    <IndependentExpensesDelete
                                                        id={item?.id}
                                                        refresh={GetAllExpenses}
                                                    />
                                                </div>
