...
import WarehouseClientDetailPayment from "./IndependentClientDetailPayment";
...
import WarehouseClientPaymentDetail from "./IndependentClientPaymentDetail";
import IndependentClientPaymentDetail from "./IndependentClientPaymentDetail";

export default function IndependentClientInvoices({ clientData, refreshKey }) {
                            ...
                            <CardBody className="p-4">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    ...
                                    <div className="flex gap-2">
                                        <IndependentClientPaymentDetail data={invoice} />
