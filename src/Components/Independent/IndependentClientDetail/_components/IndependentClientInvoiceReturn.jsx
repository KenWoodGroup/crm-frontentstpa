...
import WarehouseClientReturnInvoiceDetail from "./IndependentClientReturnInvoiceDetail";
import IndependentClientReturnInvoiceDetail from "./IndependentClientReturnInvoiceDetail";

export default function IndependentClientInvoiceReturn({ clientData, refreshKey }) {
                            ...
                            <CardBody className="p-4">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    ...
                                    <div className="flex gap-2">
                                        <IndependentClientReturnInvoiceDetail data={invoice} />
                                    </div>
                                </div>
                            </CardBody>
                        </Card>
