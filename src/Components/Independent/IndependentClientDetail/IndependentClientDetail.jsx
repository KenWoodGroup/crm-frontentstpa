...
import IndependentClientInvoices from "./_components/IndependentClientInvoices"
import IndependentClientInvoiceReturn from "./_components/IndependentClientInvoiceReturn"
import IndependentClientDetailPayment from "./_components/IndependentClientDetailPayment"

export default function IndependentClientDetail() {
    const { id } = useParams()
        ...
        <div className="mx-auto space-y-6 bg-background-light dark:bg-background-dark min-h-screen p-4 transition-colors duration-200">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        <div className="flex-1">
                            <div className="flex items-start justify-between">
                                ...
                                <IndependentClientDetailPayment
                                    client={clientData}
                                    refresh={getUser}
                                />
                            </div>
            ...
            <Card className="shadow-lg rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-card-light dark:bg-card-dark transition-colors duration-200">
                <CardBody className="p-6">
                    ...
                    {activeTab === "invoices" && (
                        <IndependentClientInvoices
                            clientData={clientData}
                            refreshKey={refreshKey} // ✅ передаём ключ
                        />
                    )}
                    {activeTab === "returns" && (
                        <IndependentClientInvoiceReturn
                            clientData={clientData}
