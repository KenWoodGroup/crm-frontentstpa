...
export default function WarehouseClientCategoryDelete({ id, refresh }) {
    ...
    const handleDelete = async () => {
        try {
            setLoading(true);
            await ClientCategory.DeleteClientCategory(id);
    ...
    return (
        <>
            ...
            >
                ...
                >
                    Вы действительно хотите удалить категория клиента?
                </DialogBody>
